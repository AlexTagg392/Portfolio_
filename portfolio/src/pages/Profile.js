      ...
      <Container style={{ marginTop: 30 }}>
        <Row>
          <Col size="md-12">
            ...
            <h6><a className="link" href="https://www.linkedin.com/public-profile/settings?trk=d_flagship3_profile_self_view_public_profile">LinkedIn | </a><a href="https://docs.google.com/document/d/1HSC-ZWWhYmK09Sp2Q9dplR12UchosU7bdGmLnQmPB40/edit?usp=sharing" className="link"> Resume</a>  </h6>
            <h6><a className="link" href="https://github.com/AlexTagg392">GitHub</a></h6>
          </Col>
        </Row>
        <Row>
          <Col size="md-12">
